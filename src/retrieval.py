...
class HybridRetrievalEngine:
    ...
    def search(
        ...
        'hybrid', 'deterministic', 'bm25', or 'semantic'.
        """
        ...
        # 4. Hybrid Mode: Candidate Union and Score Fusion
    ...
    def _fuse_hybrid_results(
        ...
        # Sort by hybrid score descending with tie-breakers
    ...
    def _convert_bm25_to_search_results(self, hits: List[BM25Hit], top_k: int) -> List[SearchResult]:
        ...
        for h in hits[:top_k]:
            ...
            results.append(self.det_engine._format_result(rec, score=h.normalized_score, reason=reason))
        return results
    ...
    def _convert_semantic_to_search_results(self, hits: List[SemanticHit], top_k: int) -> List[SearchResult]:
        ...
        for s in hits[:top_k]:
            ...
            results.append(self.det_engine._format_result(rec, score=s.similarity_score, reason=reason))
        return results
