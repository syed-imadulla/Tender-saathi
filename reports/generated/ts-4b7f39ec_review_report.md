...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 732 : 2019` | Technical review required prior to procurement. |
...
- **Why It Matches:** Modified/Technically Equivalent
...
- **Verbatim Evidence (BSB Edge Portal):** "Modified/Technically Equivalent"
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'wiring'.
  - Authoritative scope explicitly covers application: "Modified/Technically Equivalent"
...
- **Why Not Alternatives?:**
  - Alternative standard IS 7733 : 1975 has lifecycle limitations (status: REJECT).
...
- **Standards Dependencies Mapped (4):**
  ...
  - [INSTALLATION STANDARD] `IS 4051 : 1967` — *Code of practice for installation and maintenance of electrical equipment in mines* ()
