...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 778 : 1984` | Potentially missing engineering parameters: Nominal Size / Diameter (DN), Pressure Rating (PN / Class), Body Metallurgy / Material |
...
> "Installation of gate valves conforming to IS 778:1984 for water works."
...
- **Why Not Alternatives?:**
  - Alternative standard IS/ISO 10434 has lower composite relevance (0.721 vs 0.980).
