...
> "Supply of XLPE insulated power cables for 11kV distribution."

- **Decomposed Technical Components:** `general: power cables`, `general: 11kV`
- **Recommended Standard:** **IS 7098 (Part 2) : 2011** — *Crosslinked Polyethylene Insulated Thermoplastic Sheathed Cables - Part 2: For Working Voltages from 3.3 kV up to and Including 33 kV*
- **Candidate Standard:** `IS 7098 (Part 2) : 2011` | **Evidence Standard:** `IS 7098 (Part 2) : 2011` (Candidate == Evidence Grounding Established)
- **Why It Matches:** 1.1 This standard covers requirements of crosslinked polyethylene (XLPE) insulated thermoplastic sheathed electric power...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.869`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 7098 (Part 2) is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "1.1 This standard covers requirements of crosslinked polyethylene (XLPE) insulated thermoplastic sheathed electric power cables for system voltages from 3.3 kV up to and including 33 kV."
- **Why This Standard?:**
  - Official title aligns with specification: 'Crosslinked Polyethylene Insulated Thermoplastic Sheathed Cables - Part 2: For Working Voltages from 3.3 kV up to and Including 33 kV'.
  - Authoritative scope explicitly covers application: "1.1 This standard covers requirements of crosslinked polyethylene (XLPE) insulated thermoplastic sheathed electric power..."
...
- **Why Not Alternatives?:**
  - Alternative standard IS 5039 has lower composite relevance (0.229 vs 0.869).
- **Specification Review Completeness:** `POTENTIALLY_MISSING` (Potentially missing: Conductor Material, Number of Cores & Cross-section, Armouring Type)
- **Standards Dependencies Mapped (2):**
  ...
  - [CODE OF PRACTICE] `IS 3043 : 2018` — *Crosslinked Polyethylene Insulated Cables - Part 1: Up to 1100 V; Code of Practice for Earthing [IS 3043]* ()
- **Regulatory & Statutory Intelligence:** Product Certification: `NOT_IDENTIFIED` | QCO: `CURRENT` | CRS: `NOT_IDENTIFIED` | Hallmarking: `NOT_APPLICABLE`
