...
> "Supply of completely unspecified synthetic fluid for general operational use without any chemical, mechanical, or electrical specifications."

- **Recommended Standard:** **IS 302 : 2024** — *Household and Similar Electrical Appliances - Safety - Part 1 General Requirements*
- **Candidate Standard:** `IS 302 : 2024` | **Evidence Standard:** `IS 302 : 2024` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Curated reference standard for Household and Similar Electrical Appliances - Safety - Part 1 General Requirements
- **Lifecycle Status:** **ACTIVE** (Active successor replacing cited superseded `IS 589`) | **Composite Relevance Score:** `0.596`
...
- **Verbatim Evidence (BIS Standards Catalogue):** "Curated reference standard for Household and Similar Electrical Appliances - Safety - Part 1 General Requirements"
- **Why This Standard?:**
  - Official title aligns with specification: 'Household and Similar Electrical Appliances - Safety - Part 1 General Requirements'.
  - Authoritative scope explicitly covers application: "Curated reference standard for Household and Similar Electrical Appliances - Safety - Part 1 General Requirements"
...
- **Why Not Alternatives?:**
  - Alternative standard IS 302 scored lower across the 5-dimension critic evaluation.
