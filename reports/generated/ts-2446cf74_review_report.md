...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 1200 (Part 12) : 2026` | Weak evidentiary grounding between requirement and standard scope |
...
> "General unclassified masonry plastering work."

- **Decomposed Technical Components:** `general: plastering`
- **Recommended Standard:** **IS 1200 (Part 12) : 2026** — *Method of Measurement of Building and Civil Engineering Works  Part 12 Plastering and Pointing*
- **Candidate Standard:** `IS 1200 (Part 12) : 2026` | **Evidence Standard:** `IS 1200 (Part 12) : 2026` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Catalogue Record: Sectional Committee CED 44, Title: Method of Measurement of Building and Civil Engineering Works  Part...
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.040`
...
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record: Sectional Committee CED 44, Title: Method of Measurement of Building and Civil Engineering Works  Part 12 Plastering and Pointing"
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'plastering'.
  - Authoritative scope explicitly covers application: "Catalogue Record: Sectional Committee CED 44, Title: Method of Measurement of Building and Civil Engineering Works  Part..."
...
- **Why Not Alternatives?:**
  - Alternative standard IS 2395 (Part 1) : 1994 scored lower across the 5-dimension critic evaluation.
- **Specification Review Completeness:** `NOT_APPLICABLE`
- **Standards Dependencies Mapped (6):**
  - [CODE OF PRACTICE] `IS 2395 (Part 1) : 1994` — *Painting of Concrete, Masonry and Plaster Surfaces - Code of Practice - Part 1 : Operations and Workmanship* ()
  - [CODE OF PRACTICE] `IS 1597 (Part 2) : 1992` — *Construction of stone masonry - Code of practice: Part 2 ashlar masonry (First Revision)* ()
  - [CODE OF PRACTICE] `IS 2395 (Part 2) : 1994` — *Code of practice for painting concrete, masonry and plaster surfaces: Part 2 Schedules (First Revision)* ()
  - [CODE OF PRACTICE] `IS 1905 : 1987` — *Structural use of unreinforced masonry - Code of practice (Third Revision)* ()
  - [CODE OF PRACTICE] `IS 2250 : 1981` — *Preparation and use of masonry mortars - Code of practice (First Revision)* ()
  - [CODE OF PRACTICE] `IS 6041 : 1985` — *Code of practice for construction of autoclaved cellular concrete block masonry (First Revision)* ()
