...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS/ISO/TS 22002 (Part 2) : 2013` | Technical review required prior to procurement. |
...
> "Procurement of fresh organic vegetables and cafeteria catering services."

- **Decomposed Technical Components:** `general: cafeteria`, `general: catering`
- **Recommended Standard:** **IS/ISO/TS 22002 (Part 2) : 2013** — *Prerequisite programmes on food safety: Part 2 catering*
- **Candidate Standard:** `IS/ISO/TS 22002 (Part 2) : 2013` | **Evidence Standard:** `IS/ISO/TS 22002 (Part 2) : 2013` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Identical under single numbering
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.042`
...
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'catering'.
...
- **Why Not Alternatives?:**
  - Alternative standard IS 18353 : 2023 scored lower across the 5-dimension critic evaluation.
