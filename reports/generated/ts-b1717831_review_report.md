...
> "Providing daily catering and fresh vegetable supply services for staff canteen."

- **Decomposed Technical Components:** `general: catering`, `general: canteen`
- **Recommended Standard:** **IS 2491 : 2024** — *Food Hygiene - General Principles - Code of Practice*
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.519`
...
- **Why Not Alternatives?:**
  - Alternative standard FSSAI Schedule 4 has lower composite relevance (0.413 vs 0.519).
