...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 1239 (Part 2) : 1992` | Weak evidentiary grounding between requirement and standard scope |
...
- **Decomposed Technical Components:** `general: xyz abc 123`
...
- **Evidence Strength:** `WEAK` | **Provenance:** `CURATED`
...
- ⚠ **Human Technical Review Required:** Weak evidence overlap with stored scope text
