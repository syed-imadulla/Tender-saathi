...
> "Supply and installation of waterworks valves for potable water pipelines, including sluice/gate valves and check valves."

- **Decomposed Technical Components:** `general: potable water`, `general: pipelines`, `general: gate valves`, `general: check valves`, `general: waterworks valves`, `general: sluice/gate valves`, `general: potable water pipelines`, `general: supply`, `general: installation`
...
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'check valves'.
...
- **Why Not Alternatives?:**
  - Alternative standard IS/ISO 10434 has lower composite relevance (0.831 vs 0.924).
