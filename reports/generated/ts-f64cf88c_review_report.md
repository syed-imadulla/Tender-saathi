...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `NONE` | No reliable Indian Standard match found in available catalogue. |
...
> "Replacement of crane rail track for RMQC including allied works"
...
- **Why Not Alternatives?:**
  ...
  - Standard IS 15778 (Chlorinated Polyvinyl Chloride (CPVC) Pipes for Potable Hot and Cold Water Supplies - Specification) rejected: Requirement specifies crane rail machinery, but candidate standard covers pipes/plumbing.; No substantive technical vocabulary overlap with standard scope (generic words only).
  - Standard IS 6392 (Steel Pipe Flanges; Compressed Asbestos/Non-Asbestos Fiber Jointing Sheets - Specification [IS 6392]) rejected: Requirement specifies crane rail machinery, but candidate standard covers pipes/plumbing.; No substantive technical vocabulary overlap with standard scope (generic words only).
