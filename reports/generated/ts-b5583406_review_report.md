...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 15778 : 2007` | Low confidence retrieval match (<0.35 score) |
...
- **Ambiguity & Verification State:** `REVIEW_REQUIRED` — *Reason:* Primary applicable standard IS 15778 : 2007 is clearly identifiable and sufficiently supported.
