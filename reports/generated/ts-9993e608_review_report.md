...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 15778 : 2007` | Potentially missing engineering parameters: Piping Material, Diameter / Nominal Bore (DN/OD), Pressure Class / Schedule / SDR |
...
> "Pipes conforming to IS 15778:2007 shall be used."
...
- **Why Not Alternatives?:**
  - Alternative standard IS 14333 has lower composite relevance (0.643 vs 0.980).
- **Specification Review Completeness:** `UNKNOWN` (Potentially missing: Piping Material, Diameter / Nominal Bore (DN/OD), Pressure Class / Schedule / SDR, Piping Application / Service)
...
- ⚠ **Human Technical Review Required:** Potentially missing engineering parameters: Piping Material, Diameter / Nominal Bore (DN/OD), Pressure Class / Schedule / SDR; Specification lacks key parameters (Piping Material, Diameter / Nominal Bore (DN/OD), Pressure Class / Schedule / SDR). Human review recommended.
