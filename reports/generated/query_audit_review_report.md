...
- **Tender ID:** `QUERY_AUDIT`
- **Tender Title:** Ad-Hoc Query: Supply of CPVC pipes for domestic water distributi
...
### 5.1 Requirement `DEMO-REQ-001` [MATERIAL]

**Original Requirement Text:**
> "Supply of CPVC pipes for domestic water distribution"
...
- **Why Not Alternatives?:**
  - Alternative standard SP 57 (QAWSM) has lower composite relevance (0.615 vs 0.865).
