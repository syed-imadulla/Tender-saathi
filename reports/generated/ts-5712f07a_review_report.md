...
- **Why Not Alternatives?:**
  ...
  - Standard IS 8034 (Submersible Pumpsets - Specification) rejected: No substantive technical vocabulary overlap with standard scope (generic words only).; Zero substantive technical term overlap between requirement and standard.
  - Standard IS 14846 (Sluice Valve for Water Works Purposes (50 to 1200 mm Size) - Specification) rejected: No substantive technical vocabulary overlap with standard scope (generic words only).; Zero substantive technical term overlap between requirement and standard.
