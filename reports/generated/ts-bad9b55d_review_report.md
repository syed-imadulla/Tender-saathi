...
|---|---|---|---|---|
| 1 | **CRITICAL** | `TS-BAD9B55D-R001` | `IS 15778 : 2007` | Tender cited or recommended superseded standard 'IS 15778 : 2007'. |

## 5. Requirement-by-Requirement Review

### 5.1 Requirement `TS-BAD9B55D-R001` [MATERIAL]

**Original Requirement Text:**
> "Repair/ maint of CPVC pipe in lieu of rusted GI pipe at Laitumkhrah Grn"

- **Decomposed Technical Components:** `general: Repair`, `general: maint`, `general: CPVC pipe`, `general: GI pipe`, `general: plumbing`, `general: supply`, `general: maintenance`, `general: installation`, `general: testing`
...
- **Why Not Alternatives?:**
  - Alternative standard IS 18837 : 2024 scored lower across the 5-dimension critic evaluation.
