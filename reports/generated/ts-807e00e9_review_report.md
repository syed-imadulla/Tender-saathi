...
- **Decomposed Technical Components:** `general: pipes`, `general: CPVC pipes`, `general: internal water distribution`, `general: supply`, `general: installation`
...
- **Why Not Alternatives?:**
  - Alternative standard IS 783 has lower composite relevance (0.729 vs 1.000).
  - Alternative IS 783 is a general code of practice/handbook rather than a direct manufacturing product specification.
