...
|---|---|---|---|---|
| 1 | **CRITICAL** | `REQ-001` | `IS 10224 : 1982` | Tender cited or recommended superseded standard 'IS 10224 : 1982'. |
...
- **Why It Matches:** Catalogue Record Title: Ergonomic Principles in the Design of Work Systems
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.964`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 10224 : 1982 is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record Title: Ergonomic Principles in the Design of Work Systems"
- **Why This Standard?:**
  - Official title aligns with specification: 'Ergonomic Principles in the Design of Work Systems'.
  - Authoritative scope explicitly covers application: "Catalogue Record Title: Ergonomic Principles in the Design of Work Systems"
...
- **Why Not Alternatives?:**
  - Alternative standard IS 16561 (Part 5) : 2018 has lower composite relevance (0.813 vs 0.964).
