...
> "Installation of electrical wiring and safety equipment in commercial building."

- **Decomposed Technical Components:** `general: wiring`, `general: electrical wiring`, `general: safety equipment`, `general: commercial building`, `general: supply`, `general: installation`
...
- **Lifecycle Status:** **ACTIVE** (Active successor replacing cited superseded `IS 589`) | **Composite Relevance Score:** `0.833`
