...
|---|---|---|---|---|
| 1 | **LOW** | `REQ-001` | `IS 1661 : 1972` | Authoritative active standard IS 1661 : 1972 verified against scope with Medium confidence. |
...
- **Decomposed Technical Components:** `general: plastering`, `general: masonry plastering`, `general: installation`
- **Recommended Standard:** **IS 1661 : 1972** — *Code of Practice for Application of Cement and Cement-Lime Plaster Finishes*
- **Candidate Standard:** `IS 1661 : 1972` | **Evidence Standard:** `IS 1661 : 1972` (Candidate == Evidence Grounding Established)
- **Why It Matches:** IS 1661 is the national standard governing execution, surface preparation, mortar mix proportions, and curi...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.646`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 1661 is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `MODERATE` | **Provenance:** `CURATED`
- **Verbatim Evidence (BIS Standards Catalogue):** "Exact Match: IS 1661 is the national standard governing execution, surface preparation, mortar mix proportions, and curing of cement plastering repairs."
- **Why This Standard?:**
  - Official title aligns with specification: 'Code of Practice for Application of Cement and Cement-Lime Plaster Finishes'.
  - Authoritative scope explicitly covers application: "Exact Match: IS 1661 is the national standard governing execution, surface preparation, mortar mix proportions, and curi..."
