...
|---|---|---|---|---|
| 1 | **CRITICAL** | `REQ-001` | `IS 1200 (Part 12) : 2026` | Tender cited or recommended superseded standard 'IS 1200 (Part 12) : 2026'. |
...
- **Why It Matches:** Catalogue Record Title: Method of Measurement of Building and Civil Engineering Works  Part 12 Plastering and Pointing
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.810`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 1200 (Part 12) : 2026 is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record Title: Method of Measurement of Building and Civil Engineering Works  Part 12 Plastering and Pointing"
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'plastering'.
  - Authoritative scope explicitly covers application: "Catalogue Record Title: Method of Measurement of Building and Civil Engineering Works  Part 12 Plastering and Pointing"
...
- **Why Not Alternatives?:**
  - Alternative standard IS 2395 (Part 2) : 1994 scored lower across the 5-dimension critic evaluation.
