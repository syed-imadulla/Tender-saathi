...
- **Decomposed Technical Components:** `general: Overhaul`, `general: maintenance`, `general: replacement`, `general: valves`, `general: cooling water line`
- **Recommended Standard:** **NONE** — *Plastic equilibrium float valves for cold water services - Specification (first revision)*
- **Candidate Standard:** `None (Abstained)` | **Evidence Standard:** `None` (Safe Abstention)
- **Why It Matches:** Catalogue Record Title: Plastic equilibrium float valves for cold water services - Specification (first revision)
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.893`
...
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record Title: Plastic equilibrium float valves for cold water services - Specification (first revision)"
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'valves'.
  - Authoritative scope explicitly covers application: "Catalogue Record Title: Plastic equilibrium float valves for cold water services - Specification (first revision)"
