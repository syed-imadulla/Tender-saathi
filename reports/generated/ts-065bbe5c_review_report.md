...
|---|---|---|---|---|
| 1 | **CRITICAL** | `REQ-001` | `IS 12662 (Part 2) : 2025` | Tender cited or recommended superseded standard 'IS 12662 (Part 2) : 2025'. |
...
- **Recommended Standard:** **IS 12662 (Part 2) : 2025** — *Guidelines for Use of Vehicles for Collection and Transportation of Municipal Solid Wastes Part 2 Maintenance ( First Revision )*
- **Candidate Standard:** `IS 12662 (Part 2) : 2025` | **Evidence Standard:** `IS 12662 (Part 2) : 2025` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Catalogue Record Title: Guidelines for Use of Vehicles for Collection and Transportation of Municipal Solid Wastes Part...
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.964`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 12662 (Part 2) : 2025 is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record Title: Guidelines for Use of Vehicles for Collection and Transportation of Municipal Solid Wastes Part 2 Maintenance ( First Revision )"
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'maintenance'.
  - Authoritative scope explicitly covers application: "Catalogue Record Title: Guidelines for Use of Vehicles for Collection and Transportation of Municipal Solid Wastes Part..."
...
- **Why Not Alternatives?:**
  - Alternative standard IS 3844 : 1989 has lower composite relevance (0.773 vs 0.964).
