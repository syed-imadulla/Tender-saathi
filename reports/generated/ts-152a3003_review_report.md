...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 10224 : 1982` | Weak evidentiary grounding between requirement and standard scope |
...
> "Supply of ergonomic executive conference chairs."

- **Recommended Standard:** **IS 10224 : 1982** — *Ergonomic Principles in the Design of Work Systems*
- **Candidate Standard:** `IS 10224 : 1982` | **Evidence Standard:** `IS 10224 : 1982` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Catalogue Record: Sectional Committee CHD 08, Title: Ergonomic Principles in the Design of Work Systems
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.047`
- **Ambiguity & Verification State:** `REVIEW_REQUIRED` — *Reason:* Weak evidentiary grounding between requirement and standard scope; Standard IS 10224 : 1982 has unverified lifecycle status in catalogue (UNKNOWN)
- **Evidence Strength:** `WEAK` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record: Sectional Committee CHD 08, Title: Ergonomic Principles in the Design of Work Systems"
- **Why This Standard?:**
  - Official title aligns with specification: 'Ergonomic Principles in the Design of Work Systems'.
  - Authoritative scope explicitly covers application: "Catalogue Record: Sectional Committee CHD 08, Title: Ergonomic Principles in the Design of Work Systems"
  - Provenance established via BSB Edge Portal (VERIFIED).
- **Why Not Alternatives?:**
  - Alternative standard IS 15836 (Part 3) : 2008 scored lower across the 5-dimension critic evaluation.
...
- ⚠ **Human Technical Review Required:** Weak evidentiary grounding between requirement and standard scope; Standard IS 10224 : 1982 has unverified lifecycle status in catalogue (UNKNOWN)
