...
> "Providing and fixing Chlorinated Polyvinyl Chloride"

- **Decomposed Technical Components:** `general: Chlorinated Polyvinyl Chloride`, `general: construction`, `general: supply`, `general: installation`
...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.817`
...
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'Chlorinated Polyvinyl Chloride'.
...
- **Why Not Alternatives?:**
  - Alternative standard IS 16088 has lower composite relevance (0.397 vs 0.817).
