...
|---|---|---|---|---|
| 1 | **CRITICAL** | `REQ-001` | `IS/ISO 10434 : 2020` | CRITICAL: IS 10611 1983 is SUPERSEDED by IS/ISO 10434 : 2020 ('Bolted Bonnet Steel Gate Valves for the Petroleum, Petrochemical and Allied Industries'). Evidence: National Foreword explicitly states: 'This standard supersedes IS 10611 : 1983 Steel gate valves (flanged and butt-welded ends) for petroleum, petrochemicals and allied industries.' |
