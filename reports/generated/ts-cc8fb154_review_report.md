...
|---|---|---|---|---|
| 1 | **HIGH** | `TS-CC8FB154-R001` | `IS 14188 : 1994` | Weak evidentiary grounding between requirement and standard scope |

## 5. Requirement-by-Requirement Review

### 5.1 Requirement `TS-CC8FB154-R001` [PRODUCT_EQUIPMENT]
...
- **Recommended Standard:** **IS 14188 : 1994** — *Conveyor systems - Maintenance facilities - Design parameters*
- **Candidate Standard:** `IS 14188 : 1994` | **Evidence Standard:** `IS 14188 : 1994` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Match identified from the requirement context; supporting evidence needs review.
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.032`
...
- **Standards Dependencies Mapped (8):**
