...
- **Decomposed Technical Components:** `general: maintenance`, `general: cleaning`
...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.667`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 2491 is clearly identifiable and sufficiently supported.
...
- **Why Not Alternatives?:**
  - Alternative standard IS 2491 has lower composite relevance (0.404 vs 0.667).
