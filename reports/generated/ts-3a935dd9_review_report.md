...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 12662 (Part 2) : 2002` | Weak evidentiary grounding between requirement and standard scope |
...
> "General maintenance of municipal premises and cleaning."

- **Decomposed Technical Components:** `general: maintenance`
- **Recommended Standard:** **IS 12662 (Part 2) : 2002** — *Vehicles for Collection of Municipal Solid Wastes: Part 2 Guidelines for Maintenance*
- **Candidate Standard:** `IS 12662 (Part 2) : 2002` | **Evidence Standard:** `IS 12662 (Part 2) : 2002` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Catalogue Record: Sectional Committee EED 08, Title: Vehicles for Collection of Municipal Solid Wastes: Part 2 Guideline...
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.047`
- **Ambiguity & Verification State:** `REVIEW_REQUIRED` — *Reason:* Weak evidentiary grounding between requirement and standard scope; Standard IS 12662 (Part 2) : 2002 has unverified lifecycle status in catalogue (UNKNOWN)
- **Evidence Strength:** `WEAK` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record: Sectional Committee EED 08, Title: Vehicles for Collection of Municipal Solid Wastes: Part 2 Guidelines for Maintenance"
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'maintenance'.
  - Authoritative scope explicitly covers application: "Catalogue Record: Sectional Committee EED 08, Title: Vehicles for Collection of Municipal Solid Wastes: Part 2 Guideline..."
  - Provenance established via BSB Edge Portal (VERIFIED).
- **Why Not Alternatives?:**
  - Alternative standard IS 12662 (Part 2) : 2025 scored lower across the 5-dimension critic evaluation.
- **Specification Review Completeness:** `NOT_APPLICABLE`
- **Standards Dependencies Mapped (3):**
  - [INSTALLATION STANDARD] `IS 12662 (Part 2) : 2025` — *Guidelines for Use of Vehicles for Collection and Transportation of Municipal Solid Wastes Part 2 Maintenance ( First Revision )* ()
  - [INSTALLATION STANDARD] `IS 3844 : 1989` — *Code of practice for installation and maintenance of internal fire hydrants and hose reels on premises (First Revision)* ()
  - [CODE OF PRACTICE] `IS 12662 (Part 1) : 1989` — *Guidelines for use of vehicles for collection of municipal solid wastes: Part 1 selection of vehicles* ()
...
- ⚠ **Human Technical Review Required:** Weak evidentiary grounding between requirement and standard scope; Standard IS 12662 (Part 2) : 2002 has unverified lifecycle status in catalogue (UNKNOWN)
