...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 8034 : 2018` | Potentially missing engineering parameters: Pump Mechanism / Type, Discharge / Flow Rate (Q), Total Dynamic Head (H) |
...
- **Why It Matches:** 1.1 This standard covers requirements for borehole submersible pumpsets (submersible pump coupled to submersible motor)...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.739`
...
- **Verbatim Evidence (BSB Edge Portal):** "1.1 This standard covers requirements for borehole submersible pumpsets (submersible pump coupled to submersible motor) for clean cold water supply in borewells, agriculture, and irrigation."
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'pumps'.
  - Authoritative scope explicitly covers application: "1.1 This standard covers requirements for borehole submersible pumpsets (submersible pump coupled to submersible motor)..."
...
- **Why Not Alternatives?:**
  - Alternative standard IS/IEC 60034-1 has lower composite relevance (0.580 vs 0.739).
