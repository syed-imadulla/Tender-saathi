...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 17230 : 2019` | Weak evidentiary grounding between requirement and standard scope |
...
> "Procurement of office stationary, printer cartridges, and executive chairs."

- **Recommended Standard:** **IS 17230 : 2019** — *Plastic carry case for storage, transportation and carriage of voter verifiable paper audit trail (vvpat) printer - Specification*
- **Candidate Standard:** `IS 17230 : 2019` | **Evidence Standard:** `IS 17230 : 2019` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Catalogue Record: Sectional Committee PCD 12, Title: Plastic carry case for storage, transportation and carriage of vote...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.033`
...
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record: Sectional Committee PCD 12, Title: Plastic carry case for storage, transportation and carriage of voter verifiable paper audit trail (vvpat) printer - Specification"
- **Why This Standard?:**
  - Official title aligns with specification: 'Plastic carry case for storage, transportation and carriage of voter verifiable paper audit trail (vvpat) printer - Specification'.
  - Authoritative scope explicitly covers application: "Catalogue Record: Sectional Committee PCD 12, Title: Plastic carry case for storage, transportation and carriage of vote..."
...
- **Why Not Alternatives?:**
  - Alternative standard IS 14486 : 1997 scored lower across the 5-dimension critic evaluation.
- **Specification Review Completeness:** `NOT_APPLICABLE`
- **Regulatory & Statutory Intelligence:** Product Certification: `NOT_IDENTIFIED` | QCO: `NOT_IDENTIFIED` | CRS: `APPLICABLE` | Hallmarking: `NOT_APPLICABLE`
