...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `NONE` | All candidates rejected by Applicability Gate. |
...
> "Procurement of office stationery, staplers, ballpoint pens, and paper pads."

- **Decomposed Technical Components:** `general: staplers`, `general: ballpoint pens`, `general: paper pads`, `general: office use`, `general: supply`
...
- **Why It Matches:** No reliable Indian Standard match found in the available catalogue.
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.000`
- **Ambiguity & Verification State:** `NO_RELIABLE_MATCH` — *Reason:* Retrieved candidates did not pass the domain/product applicability checks.
...
- **Why Not Alternatives?:**
  - Standard IS 101 (Methods of Sampling and Test for Paints, Varnishes and Related Products - Part 5 Mechanical Tests - Section 8 Determination of Resistance to Abrasion by Abrasive-Paper Covered Wheel and Linearly Reciprocating Test Specimen) rejected: Equipment mismatch: Requirement specifies 'ballpoint, pad, pads, paper, pen, pens, stapler, staplers' which is not covered by standard 'Methods of Sampling and Test for Paints, Varnishes and Related Products - Part 5 Mechanical Tests - Section 8 Determination of Resistance to Abrasion by Abrasive-Paper Covered Wheel and Linearly Reciprocating Test Specimen'; No substantive technical vocabulary overlap with standard scope (generic words only).; Zero substantive technical term overlap between requirement and standard.
  - Standard IS 101 (Methods of Sampling and Test for Paints Varnishes and Related Products - Part 5 Mechanical Tests - Section 6 Determination of Resistance to Abrasion by Abrasive-Paper Covered Wheels and Rotating Test Specimen) rejected: Equipment mismatch: Requirement specifies 'ballpoint, pad, pads, paper, pen, pens, stapler, staplers' which is not covered by standard 'Methods of Sampling and Test for Paints Varnishes and Related Products - Part 5 Mechanical Tests - Section 6 Determination of Resistance to Abrasion by Abrasive-Paper Covered Wheels and Rotating Test Specimen'; No substantive technical vocabulary overlap with standard scope (generic words only).; Zero substantive technical term overlap between requirement and standard.
