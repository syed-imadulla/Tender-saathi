...
|---|---|---|---|---|
| 1 | **MEDIUM** | `TS-D6B5CAE5-R001` | `IS 1255 : 1983` | Authoritative active standard IS 1255 : 1983 verified against scope with Medium confidence. |

## 5. Requirement-by-Requirement Review

### 5.1 Requirement `TS-D6B5CAE5-R001` [GENERAL_SPECIFICATION]
...
- **Recommended Standard:** **IS 1255 : 1983** — *Crosslinked Polyethylene Insulated Cables - Part 1: Up to 1100 V; Code of Practice for Installation of Power Cables [IS 1255]*
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.508`
...
- **Why This Standard?:**
  - Official title aligns with specification: 'Crosslinked Polyethylene Insulated Cables - Part 1: Up to 1100 V; Code of Practice for Installation of Power Cables [IS 1255]'.
...
- **Why Not Alternatives?:**
  - Alternative standard IS 7098 (Part 1) scored lower across the 5-dimension critic evaluation.
