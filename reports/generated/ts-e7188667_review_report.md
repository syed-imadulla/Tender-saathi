...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 7098 (Part 1) : 1988` | Potentially missing engineering parameters: Voltage Grade, Conductor Material, Insulation Material |
...
- **Candidate Standard:** `IS 7098 (Part 1) : 1988` | **Evidence Standard:** `IS 7098 (Part 1) : 1988` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Partial Match: Proposed standard covers the physical cable, but the tender explicitly mandates Providing and Laying unde...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.671`
- **Ambiguity & Verification State:** `REVIEW_REQUIRED` — *Reason:* Potentially missing engineering parameters: Voltage Grade, Conductor Material, Insulation Material; Specification lacks key parameters (Voltage Grade, Conductor Material, Insulation Material). Human review recommended.
...
- **Why Not Alternatives?:**
  - Alternative standard IS 1255 scored lower across the 5-dimension critic evaluation.
