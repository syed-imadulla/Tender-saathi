...
- **Decomposed Technical Components:** `general: CPVC pipes`, `general: CPVC pipe`, `general: plumbing`, `general: supply`, `general: installation`
...
- **Why Not Alternatives?:**
  - Alternative standard SP 57 (QAWSM) has lower composite relevance (0.470 vs 0.980).
