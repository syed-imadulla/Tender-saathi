...
- **Tender ID:** `TS-8E75ED7E`
- **Source File:** `eProcurement System Government of India7.pdf`
...
### 5.1 Requirement `TS-8E75ED7E-R001` [INSTALLATION_EXECUTION]

**Original Requirement Text:**
> "UPVC Partition Wall Work for Conversion of Seafood Authentication Laboratory into Conventional Microbiology Laboratory at Central Laboratory (CAGPFTL), RGCA-HQ, Karaimedu, Sirkali"

- **Decomposed Technical Components:** `general: UPVC Partition Wall`, `general: Laboratory`, `general: UPVC partition wall for laboratory conversion`, `general: supply`, `general: installation`
- **Recommended Standard:** **IS 16088 : 2016** — *Unplasticized Polyvinyl Chloride (uPVC) Profiles for the Fabrication of Windows and Doors - Specification*
- **Candidate Standard:** `IS 16088 : 2016` | **Evidence Standard:** `IS 16088 : 2016` (Candidate == Evidence Grounding Established)
- **Why It Matches:** IS 16088 governs extruded multi-chamber UPVC hollow profiles used in architectural partitions and frame ass...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.730`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 16088 is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `MODERATE` | **Provenance:** `CURATED`
- **Verbatim Evidence (BIS Standards Catalogue):** "Exact Match: IS 16088 governs extruded multi-chamber UPVC hollow profiles used in architectural partitions and frame assemblies."
- **Why This Standard?:**
  - Official title aligns with specification: 'Unplasticized Polyvinyl Chloride (uPVC) Profiles for the Fabrication of Windows and Doors - Specification'.
  - Authoritative scope explicitly covers application: "Exact Match: IS 16088 governs extruded multi-chamber UPVC hollow profiles used in architectural partitions and frame ass..."
