...
|---|---|---|---|---|
| 1 | **MEDIUM** | `TS-7F4D06B7-R001` | `IS 1255 : 1983` | Authoritative active standard IS 1255 : 1983 verified against scope with Medium confidence. |

## 5. Requirement-by-Requirement Review

### 5.1 Requirement `TS-7F4D06B7-R001` [GENERAL_SPECIFICATION]
