...
> "Supply and installation of copper alloy / brass gate valves for waterworks potable water supply"

- **Decomposed Technical Components:** `general: gate valves`, `general: potable water supply`
- **Recommended Standard:** **IS 778 : 1984** — *Specification for Copper Alloy Gate, Globe and Check Valves for Waterworks Purposes*
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.846`
...
- **Why This Standard?:**
  - Official title aligns with specification: 'Specification for Copper Alloy Gate, Globe and Check Valves for Waterworks Purposes'.
...
- **Why Not Alternatives?:**
  - Alternative standard IS/ISO 10434 has lower composite relevance (0.659 vs 0.846).
- **Specification Review Completeness:** `POTENTIALLY_MISSING` (Potentially missing: Nominal Size / Diameter (DN), Pressure Rating (PN / Class))
