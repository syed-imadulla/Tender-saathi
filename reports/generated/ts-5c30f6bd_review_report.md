...
|---|---|---|---|---|
| 1 | **HIGH** | `TS-5C30F6BD-R001` | `NONE` | Tender requirement specifies 'cable' equipment but omits critical discriminating technical parameters (material, voltage rating). A specific Indian Standard cannot be safely selected without guessing. |

## 5. Requirement-by-Requirement Review

### 5.1 Requirement `TS-5C30F6BD-R001` [GENERAL_SPECIFICATION]
