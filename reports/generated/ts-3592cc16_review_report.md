...
- **Why Not Alternatives?:**
  - Standard IS 18703 : 2024 (Ativisha (Aconitum heterophyllum Wall. ex. Royle) Root for use in  Traditional Medicine ï¿½ Specification) rejected: No substantive technical vocabulary overlap with standard scope (generic words only).; Zero substantive technical term overlap between requirement and standard.
  - Standard IS 18192 : 2023 (Apamarga Achyranthes aspera L Whole Plant for use in   Traditional Medicine Specification) rejected: No substantive technical vocabulary overlap with standard scope (generic words only).; Zero substantive technical term overlap between requirement and standard.
  - Standard IS 18201 : 2023 (Nimba Azadirachta indica A Juss Flower for use in  Traditional Medicine  Specification) rejected: No substantive technical vocabulary overlap with standard scope (generic words only).; Zero substantive technical term overlap between requirement and standard.
