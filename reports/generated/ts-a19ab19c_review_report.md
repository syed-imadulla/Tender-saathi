...
- **Why It Matches:** Catalogue Record Title: Plastic carry case for storage, transportation and carriage of voter verifiable paper audit trai...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.663`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 17230 : 2019 is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record Title: Plastic carry case for storage, transportation and carriage of voter verifiable paper audit trail (vvpat) printer - Specification"
- **Why This Standard?:**
  ...
  - Authoritative scope explicitly covers application: "Catalogue Record Title: Plastic carry case for storage, transportation and carriage of voter verifiable paper audit trai..."
