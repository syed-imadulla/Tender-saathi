...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 1786 : 2008` | Potentially missing engineering parameters: Voltage Grade, Conductor Material, Insulation Material |
...
> "High strength deformed steel bars and wires for concrete reinforcement conforming to IS 1786 Grade Fe 500D."

- **Decomposed Technical Components:** `general: concrete`, `general: Grade Fe`
- **Recommended Standard:** **IS 1786 : 2008** — *High Strength Deformed Steel Bars and Wires for Concrete Reinforcement - Specification*
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `1.000`
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (Tender Document):** "Tender explicitly requires compliance with IS 1786."
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'concrete'.
  - Authoritative scope explicitly covers application: "Tender explicitly requires compliance with IS 1786."
...
- **Why Not Alternatives?:**
  - Alternative standard SP 34 has lower composite relevance (0.635 vs 1.000).
  - Alternative SP 34 is a general code of practice/handbook rather than a direct manufacturing product specification.
