...
- **Recommended Standard:** **IS 4308 : 2019** — *Dry Chemical Powders for Fire Fighting - BC, ABC and D Types - Specification ( Third Revision )*
- **Candidate Standard:** `IS 4308 : 2019` | **Evidence Standard:** `IS 4308 : 2019` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Catalogue Record Title: Dry Chemical Powders for Fire Fighting - BC, ABC and D Types - Specification ( Third Revision )
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.816`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 4308 : 2019 is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record Title: Dry Chemical Powders for Fire Fighting - BC, ABC and D Types - Specification ( Third Revision )"
- **Why This Standard?:**
  - Official title aligns with specification: 'Dry Chemical Powders for Fire Fighting - BC, ABC and D Types - Specification ( Third Revision )'.
  - Authoritative scope explicitly covers application: "Catalogue Record Title: Dry Chemical Powders for Fire Fighting - BC, ABC and D Types - Specification ( Third Revision )"
...
- **Why Not Alternatives?:**
  - Alternative standard IS 4308 : 2003 has lifecycle limitations (status: REJECT).
