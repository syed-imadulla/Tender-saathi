...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS/IEC 61557 (Part 4) : 2019` | Technical review required prior to procurement. |
...
- **Decomposed Technical Components:** `general: Earthing`, `general: 33 kV`, `general: earthing system`, `general: equipotential bonding`, `general: distribution substation`, `general: supply`, `general: installation`, `general: testing`
- **Recommended Standard:** **IS/IEC 61557 (Part 4) : 2019** — *Electrical safety in low voltage distribution systems up to 1 000 V ac and 1 500 V dc  Equipment for testing measuring or monitoring of protective measures Part 4: Resistance of earth connection and equipotential bonding*
- **Candidate Standard:** `IS/IEC 61557 (Part 4) : 2019` | **Evidence Standard:** `IS/IEC 61557 (Part 4) : 2019` (Candidate == Evidence Grounding Established)
- **Why It Matches:** Identical under single numbering
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.049`
...
- **Why This Standard?:**
  - Standard title directly matches requirement component(s): 'equipotential bonding, testing'.
...
- **Why Not Alternatives?:**
  - Alternative standard IS 16624 : 2017 scored lower across the 5-dimension critic evaluation.
...
- ⚠ **Human Technical Review Required:** Technical review required prior to procurement.
