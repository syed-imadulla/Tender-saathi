...
|---|---|---|---|---|
| 1 | **LOW** | `REQ-001` | `IS 15778 : 2007` | Evidence-backed dependency 'IS 12235 : 2004' is potentially missing from tender. |
...
- **Ambiguity & Verification State:** `REVIEW_REQUIRED` — *Reason:* Primary applicable standard IS 15778 is clearly identifiable and sufficiently supported.
...
- **Why Not Alternatives?:**
  - Alternative standard SP 57 (QAWSM) has lower composite relevance (0.844 vs 1.000).
...
- ⚠ **Human Technical Review Required:** Authoritative active standard IS 15778 : 2007 verified against scope with High confidence.
