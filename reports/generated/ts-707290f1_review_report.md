...
- **Decomposed Technical Components:** `general: Maintenance`, `general: Pumps`, `general: mechanical maintenance`
- **Recommended Standard:** **IS 9694 : 2023** — *Selection, Installation, Operation And Maintenance Of Horizontal Centrifugal Pumps For Agriculture Application — Code Of Practice - Part 1 Selection*
...
- **Lifecycle Status:** **ACTIVE** | **Composite Relevance Score:** `0.707`
...
- **Verbatim Evidence (BIS Standards Catalogue):** "Curated reference standard for Selection, Installation, Operation And Maintenance Of Horizontal Centrifugal Pumps For Agriculture Application — Code Of Practice - Part 1 Selection"
- **Why This Standard?:**
