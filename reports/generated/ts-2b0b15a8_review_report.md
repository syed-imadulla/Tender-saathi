...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `IS 15778 : 2007` | Standard IS 15778 : 2007 has unverified lifecycle status in catalogue (UNKNOWN) |
...
> "Supply and installation of CPVC pipes conforming to IS 15778."
...
- **Why It Matches:** Tender explicitly requires compliance with IS 15778 : 2007.
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `1.000`
- **Ambiguity & Verification State:** `REVIEW_REQUIRED` — *Reason:* Standard IS 15778 : 2007 has unverified lifecycle status in catalogue (UNKNOWN)
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (Tender Document):** "Tender explicitly requires compliance with IS 15778 : 2007."
- **Why This Standard?:**
  ...
  - Authoritative scope explicitly covers application: "Tender explicitly requires compliance with IS 15778 : 2007."
  - Provenance established via Tender Document (VERIFIED).
- **Why Not Alternatives?:**
  - Alternative standard IS 16088 : 2012 has lower composite relevance (0.048 vs 1.000).
  - Alternative standard IS 16088 : 2012 lacks strong grounded scope evidence for this requirement.
...
- ⚠ **Human Technical Review Required:** Standard IS 15778 : 2007 has unverified lifecycle status in catalogue (UNKNOWN)
