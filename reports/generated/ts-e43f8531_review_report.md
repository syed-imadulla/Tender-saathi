...
|---|---|---|---|---|
| 1 | **CRITICAL** | `REQ-001` | `IS 15778 : 2007` | Tender cited or recommended superseded standard 'IS 15778 : 2007'. |
...
- **Decomposed Technical Components:** `general: CPVC pipes`, `general: potable water`, `general: potable water distribution`, `general: supply`, `general: installation`
...
- **Why It Matches:** Catalogue Record Title: Chlorinated Polyvinyl Chloride (CPVC) Pipes for Potable Hot and Cold Water Distribution Supplies...
- **Lifecycle Status:** **UNKNOWN** | **Composite Relevance Score:** `0.980`
- **Ambiguity & Verification State:** `CLEAR` — *Reason:* Primary applicable standard IS 15778 : 2007 is clearly identifiable and sufficiently supported.
- **Evidence Strength:** `STRONG` | **Provenance:** `VERIFIED`
- **Verbatim Evidence (BSB Edge Portal):** "Catalogue Record Title: Chlorinated Polyvinyl Chloride (CPVC) Pipes for Potable Hot and Cold Water Distribution Supplies - Specification"
- **Why This Standard?:**
  ...
  - Authoritative scope explicitly covers application: "Catalogue Record Title: Chlorinated Polyvinyl Chloride (CPVC) Pipes for Potable Hot and Cold Water Distribution Supplies..."
...
- **Why Not Alternatives?:**
  - Alternative standard IS 17546 : 2021 scored lower across the 5-dimension critic evaluation.
...
- **Standards Dependencies Mapped (4):**
  ...
  - [INSTALLATION STANDARD] `IS 7634 (Part 2) : 2012` — *Plastics Pipes Selection, Handling, Storage and Installation for Potable Water Supplies - Code of Practice: Part 2 Laying and Jointing of Polyethylene (PE) Pipes  (First Revision)* ()
