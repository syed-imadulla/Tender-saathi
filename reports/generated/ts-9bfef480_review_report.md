...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `NONE` | Multiple competing Indian Standards (IS 14333 : 1996 and IS 15328 : 2003) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (material (hdpe vs pvc)) to select between them. |
...
> "Laying of sewerage pipeline without pipe specification."

- **Decomposed Technical Components:** `general: Laying of`, `general: sewerage pipeline`
...
- **Ambiguity & Verification State:** `AMBIGUOUS` — *Reason:* Multiple competing Indian Standards (IS 14333 : 1996 and IS 15328 : 2003) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (material (hdpe vs pvc)) to select between them.
...
- **Why This Standard?:**
  - Multiple competing Indian Standards (IS 14333 : 1996 and IS 15328 : 2003) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (material (hdpe vs pvc)) to select between them.
- **Why Not Alternatives?:**
  - Candidate standard IS 14333 : 1996 competes within separation threshold: material (hdpe vs pvc).
  - Candidate standard IS 15328 : 2003 competes within separation threshold: material (hdpe vs pvc).
...
- ⚠ **Human Technical Review Required:** Multiple competing Indian Standards (IS 14333 : 1996 and IS 15328 : 2003) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (material (hdpe vs pvc)) to select between them.
