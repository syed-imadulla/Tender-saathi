...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `NONE` | Multiple competing Indian Standards (IS 7098 (Part 1) and IS 7098 (Part 2)) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (voltage_rating (LV vs MV/HV)) to select between them. |
...
> "Installation of high-voltage transmission cable connection."

- **Decomposed Technical Components:** `general: cable`
