...
|---|---|---|---|---|
| 1 | **HIGH** | `REQ-001` | `NONE` | Multiple competing Indian Standards (IS 778 : 1984 and IS 14148 : 2021) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (valve_type (gate vs check)) to select between them. |
...
- **Ambiguity & Verification State:** `AMBIGUOUS` — *Reason:* Multiple competing Indian Standards (IS 778 : 1984 and IS 14148 : 2021) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (valve_type (gate vs check)) to select between them.
...
- **Why This Standard?:**
  - Multiple competing Indian Standards (IS 778 : 1984 and IS 14148 : 2021) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (valve_type (gate vs check)) to select between them.
- **Why Not Alternatives?:**
  - Candidate standard IS 778 : 1984 competes within separation threshold: valve_type (gate vs check).
  - Candidate standard IS 14148 : 2021 competes within separation threshold: valve_type (gate vs check).
...
- ⚠ **Human Technical Review Required:** Multiple competing Indian Standards (IS 778 : 1984 and IS 14148 : 2021) have competing applicability for the same procurement object. The tender does not contain distinguishing specifications (valve_type (gate vs check)) to select between them.
