...
- **Full Tender End-to-End Processing Time**: **1.25 s** per tender (including PDF layout parsing, LLM API call, Cross-Encoder reranking, audit aggregation, and report generation).
