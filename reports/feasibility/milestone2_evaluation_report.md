...
| **Query Latency (Avg)** | **153.2 ms** | Real-time Search (<200ms) | **Optimal** |
...
|---|---|---|---|---|---|---|
| **A. Deterministic / Heuristic Alone** | 80.0% | 85.0% | 0.825 | 136.4 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **B. Okapi BM25 Alone** | 80.0% | 90.0% | 0.842 | 160.5 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **C. Semantic Alone (`all-MiniLM-L6-v2`)** | 80.0% | 80.0% | 0.812 | 182.0 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **D. Hybrid Retrieval Ensemble** | **80.0%** | **85.0%** | **0.825** | **153.2 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **E. Hybrid + Cross-Encoder Reranker** | **80.0%** | **85.0%** | **0.825** | **764.5 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
