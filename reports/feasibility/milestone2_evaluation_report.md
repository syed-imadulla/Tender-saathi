...
| **Query Latency (Avg)** | **187.5 ms** | Real-time Search (<200ms) | **Optimal** |
...
|---|---|---|---|---|---|---|
| **A. Deterministic / Heuristic Alone** | 95.0% | 100.0% | 0.975 | 121.6 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **B. Okapi BM25 Alone** | 95.0% | 100.0% | 0.975 | 169.0 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **C. Semantic Alone (`all-MiniLM-L6-v2`)** | 90.0% | 95.0% | 0.938 | 139.9 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **D. Hybrid Retrieval Ensemble** | **95.0%** | **100.0%** | **0.975** | **187.5 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **E. Hybrid + Cross-Encoder Reranker** | **95.0%** | **100.0%** | **0.975** | **630.4 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
