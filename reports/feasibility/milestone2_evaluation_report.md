...
| **Query Latency (Avg)** | **161.0 ms** | Real-time Search (<200ms) | **Optimal** |
...
|---|---|---|---|---|---|---|
| **A. Deterministic / Heuristic Alone** | 90.0% | 95.0% | 0.925 | 135.7 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **B. Okapi BM25 Alone** | 90.0% | 95.0% | 0.925 | 151.5 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **C. Semantic Alone (`all-MiniLM-L6-v2`)** | 85.0% | 85.0% | 0.850 | 173.4 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **D. Hybrid Retrieval Ensemble** | **90.0%** | **90.0%** | **0.900** | **161.0 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **E. Hybrid + Cross-Encoder Reranker** | **90.0%** | **90.0%** | **0.900** | **856.6 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
