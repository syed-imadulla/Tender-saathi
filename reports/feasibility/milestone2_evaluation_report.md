...
| **Query Latency (Avg)** | **183.5 ms** | Real-time Search (<200ms) | **Optimal** |
...
|---|---|---|---|---|---|---|
| **A. Deterministic / Heuristic Alone** | 75.0% | 80.0% | 0.775 | 150.5 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **B. Okapi BM25 Alone** | 75.0% | 85.0% | 0.792 | 127.0 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **C. Semantic Alone (`all-MiniLM-L6-v2`)** | 75.0% | 75.0% | 0.762 | 176.7 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **D. Hybrid Retrieval Ensemble** | **75.0%** | **80.0%** | **0.775** | **183.5 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **E. Hybrid + Cross-Encoder Reranker** | **75.0%** | **80.0%** | **0.775** | **766.0 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
