...
| **Query Latency (Avg)** | **160.9 ms** | Real-time Search (<200ms) | **Optimal** |
...
|---|---|---|---|---|---|---|
| **A. Deterministic / Heuristic Alone** | 90.0% | 95.0% | 0.925 | 131.5 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **B. Okapi BM25 Alone** | 90.0% | 95.0% | 0.925 | 133.4 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **C. Semantic Alone (`all-MiniLM-L6-v2`)** | 85.0% | 85.0% | 0.850 | 148.5 ms | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **D. Hybrid Retrieval Ensemble** | **90.0%** | **90.0%** | **0.900** | **160.9 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
| **E. Hybrid + Cross-Encoder Reranker** | **90.0%** | **90.0%** | **0.900** | **697.9 ms** | `IS/IEC 61800-2 : 2015` (TOP1_HIT) | `IS/IEC 60034-1 : 2017` (TOP1_HIT) |
